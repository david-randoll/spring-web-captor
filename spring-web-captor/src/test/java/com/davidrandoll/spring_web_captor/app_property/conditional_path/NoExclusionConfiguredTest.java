...
@TestPropertySource(properties = {
        "web-captor.excluded-endpoints="
})
class NoExclusionConfiguredTest {
    @Autowired
    ...
    @Test
    void allRequestsShouldBePublishedWhenNoExclusionConfigured() throws Exception {
        mockMvc.perform(get("/test/filter/none"))
