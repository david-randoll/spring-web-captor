...
class MethodExcludedTest {
    ...
    @Test
    void testMethodNotCapturedWhenDisabled() throws Exception {
        ...
        assertNull(request.getMethod(), "Expected HTTP method to be null when disabled");
    }
}