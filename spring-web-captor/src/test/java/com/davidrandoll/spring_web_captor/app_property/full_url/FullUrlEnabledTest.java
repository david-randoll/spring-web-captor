...
class FullUrlEnabledTest {
    ...
    @Test
    void testFullUrlIsCapturedWhenEnabled() throws Exception {
        ...
        assertNotNull(request.getFullUrl(), "Expected fullUrl to be present");
        assertTrue(request.getFullUrl().contains("/test/property/echo"), "Expected fullUrl to contain full path and query");
    }
}