...
class QueryParamsExcludedTest {
    ...
    @Test
    void testQueryParamsNotCapturedWhenDisabled() throws Exception {
        ...
        assertNull(request.getQueryParams(), "Query params should not be captured");
    }
}