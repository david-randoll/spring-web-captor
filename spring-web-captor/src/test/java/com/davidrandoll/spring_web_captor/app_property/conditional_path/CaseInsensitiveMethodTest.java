...
@TestPropertySource(properties = {
        ...
        "web-captor.excluded-endpoints[0].path=/test/filter/case"
})
class CaseInsensitiveMethodTest {
    @Autowired
    ...
    @Test
    void postShouldBeExcludedEvenIfLowercase() throws Exception {
        mockMvc.perform(post("/test/filter/case"))
