package com.davidrandoll.spring_web_captor.app_property.request_headers;
...
class RequestHeadersIncludedTest {
    ...
    @Test
    void testMethodCapturedWhenEnabled() throws Exception {
        ...
        assertNotNull(request.getHeaders(), "Headers should be captured");
        assertEquals("abc123", request.getHeaders().getFirst("X-Custom-Header"));
    }
}