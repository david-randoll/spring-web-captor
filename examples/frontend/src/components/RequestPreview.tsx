  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h2 className="text-xl font-semibold text-slate-100 mb-2">{demo.title}</h2>
        ...
        <div className="p-5 font-mono text-sm space-y-3">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-slate-300 break-all">
              <span className="text-slate-500">localhost:8085</span>
          ...
          {demo.body && (
            <div className="pt-2 border-t border-slate-800/50">
              ...
              <pre className="text-xs text-emerald-400/80 whitespace-pre-wrap bg-slate-950/50 rounded-lg p-3 max-h-48 overflow-auto">
                {demo.body}
              </pre>
            </div>
          )}
      ...
      <div className="flex justify-center mt-8">
        <button
          onClick={onSend}
          className="group flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl px-8 py-3 text-sm font-semibold transition-all hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20"
        >
