...
class ResponseHeadersExcludedTest {
    ...
    @Test
    void testResponseHeadersNotCapturedWhenDisabled() throws Exception {
        ...
        assertTrue(responseHeaders == null || responseHeaders.isEmpty(), "Response headers should not be captured");
    }
}