...
class ErrorDetailIncludedTest {
    ...
    @Test
    void testErrorDetailsCapturedWhenEnabled() throws Exception {
        ...
        assertNotNull(errorDetails, "Error details should be captured");
        assertTrue(errorDetails.containsKey("exception"));
        assertEquals("Simulated error for testing", errorDetails.get("message"));
    }
}