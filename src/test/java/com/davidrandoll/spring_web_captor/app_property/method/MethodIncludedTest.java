package com.davidrandoll.spring_web_captor.app_property.method;
...
class MethodIncludedTest {
    ...
    void testMethodCapturedWhenEnabled() throws Exception {
        ...
        assertEquals("POST", request.getMethod().getMethod(), "Expected HTTP method to be captured");
    }
}